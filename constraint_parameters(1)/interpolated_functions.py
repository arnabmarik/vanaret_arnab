...
from constraint_parameters.bounds_initialization import create_bounds_dict


class StructureInterpolation:

    def __init__(self):
        with open("scale.p", "rb") as f:
            scale = pickle.load(f)
        self.scale = scale
