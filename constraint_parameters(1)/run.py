                    ...
                    for nx in [4]:
                        for ny in [4]:
                            for _ in range(1):
                                ...
                                if not os.path.exists('./result(variable_coupling_density)/result(variable_coupling_density)(nx = ' + str(nx) + ')'):
                                    os.makedirs('./result(variable_coupling_density)/result(variable_coupling_density)(nx = ' + str(nx) + ')')

                                result = pd.concat([df_mdf, df_idf_tol], axis=1)
                                result.to_csv('result(variable_coupling_density)/result(variable_coupling_density)(nx = ' + str(nx) + ')/result_new_values' + '('
                                              + str(d_large) + ').csv')
