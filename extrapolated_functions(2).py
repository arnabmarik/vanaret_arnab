...
import numpy as np
import pickle
from examples.scripts.interpolated_functions import StructureInterpolation
from examples.scripts.interpolated_functions import AerodynamicsInterpolation
from examples.scripts.interpolated_functions import PropulsionInterpolation
from examples.scripts.interpolated_functions import PerformanceInterpolation
...
ny = 7
a = Structure()
print(a.y1(nx, ny, .4 * np.ones(4 * nx + 5 * ny)))
